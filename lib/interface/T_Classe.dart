...
void main() {
  runApp(const T_Classe());
}

class T_Classe extends StatelessWidget {
  const T_Classe({Key? key}) : super(key: key);
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton.icon(
              onPressed: () => Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_) => const T_Classe())),
