...
class MyChart0000 extends StatelessWidget {
  @override
            ...
            Padding(
              ...
              child: AspectRatio(
                ...
                child: DChartBar(
                  data: [
                    {
                      'id': 'Apontamento por Grau',
                      'data': [
                        {'domain': 'Grau-1', 'measure': 1520},
                        {'domain': 'Grau-2', 'measure': 520},
                        {'domain': 'Grau-3', 'measure': 250},
                      ],
                    },
                  ],
            ...
            Padding(
              ...
              child: AspectRatio(
                ...
                child: DChartBar(
                  data: [
                    {
                      'id': 'Quantidade de auditorias Realizadas',
                      'data': [
                        {'domain': '2018', 'measure': 25},
                        {'domain': '2019', 'measure': 42},
                        {'domain': '2020', 'measure': 56},
                        {'domain': '2021', 'measure': 85},
                      ],
                    },
                  ],
                  domainLabelPaddingToAxisLine: 16,
                  ...
                  data: [
                    {
                      'id': 'Qtd por Grau',
                      'data': [
                        {'domain': 'Grau-1', 'measure': 3},
                        {'domain': 'Grau-2', 'measure': 4},
                        {'domain': 'Grau-3', 'measure': 6},
                      ],
                    },
                  ],
                  domainLabelPaddingToAxisLine: 16,
