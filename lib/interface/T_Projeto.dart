...
void main() {
  runApp(const T_Projeto());
}

class T_Projeto extends StatelessWidget {
  const T_Projeto({Key? key}) : super(key: key);
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton.icon(
              onPressed: () => Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_) => const T_Projeto())),
